...
public:
    long long maxScore(vector<int>& a, vector<int>& b, int k) {
        ...
        forn(i,n-k+1)
        {
                ...
                ans=max(ans,curr);
                    if(contain[arr[i].second.second]>0)
                    {
                        contain[arr[i].second.second]--;
                    ...
                    {
                        if(x.count({arr[i].second.first,arr[i].second.second}))             
                        {
                            x.erase(x.find({arr[i].second.first,arr[i].second.second}));
                        }
                    }
        }
        return ans;
