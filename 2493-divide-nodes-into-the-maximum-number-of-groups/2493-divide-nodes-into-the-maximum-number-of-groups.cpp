...
bool dfs(int v,v64 &vis,uv64 &adj,int curr,u64&col)
{
    vis[v]=1;
    col[v]=curr;
    for(auto child:adj[v])
    {
        if(vis[child]==0)
        {
            if(dfs(child,vis,adj,1-curr,col))
            {
                return true;
            }
        }
